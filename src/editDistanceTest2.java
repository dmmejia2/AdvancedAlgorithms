public class editDistanceTest2{	
	...
	public static int editDistance(String s1, String s2, int deleteCost, int replaceCost, int insertCost){
	...
	public static void main(String[] args)   {
		...
		System.out.println(S1+" "+ S2 +" " + editDistance(S1,S2,2,3,4));
		editDistance(S1,S2,2,3,4);
